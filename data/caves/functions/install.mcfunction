...
execute if score $install.ver cave_data matches 16 run tellraw @a [{"text":"Error: This Cave Biomes v1.1.2 requires Minecraft +1.16. Click [here] to download alternative versions.","color":"red","clickEvent":{"action":"open_url","value":"https://github.com/ImCoolYeah105/CaveBiomes/releases"}}]
...
execute if score $install cave_data matches 1 run tellraw @a [{"text":"[Loaded Cave Biomes v1.1.2]","color":"dark_green"}]
