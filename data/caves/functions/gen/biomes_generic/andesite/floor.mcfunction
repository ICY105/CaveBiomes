...
execute if score out_0 cave_data matches 000..249 run setblock ~ ~ ~ minecraft:stone_bricks
execute if score out_0 cave_data matches 250..999 run setblock ~ ~ ~ minecraft:polished_andesite

execute if score out_1 cave_data matches 000..099 positioned ~ ~1 ~ if block ~ ~ ~ #caves:cave_decoration run setblock ~ ~ ~ minecraft:andesite_slab
