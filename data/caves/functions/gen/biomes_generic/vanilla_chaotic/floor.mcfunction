...
execute if score $gen.out_0 cave_data matches 500..699 run setblock ~ ~ ~ minecraft:gravel
...
execute if score $gen.out_1 cave_data matches 000..99 positioned ~ ~1 ~ if block ~ ~ ~ #caves:cave_decoration run setblock ~ ~ ~ minecraft:stone_slab
