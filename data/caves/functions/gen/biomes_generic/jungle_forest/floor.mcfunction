...
execute if score $gen.out_1 cave_data matches 001..003 if score $config.enable.spawner cave_data matches 1 run setblock ~ ~ ~ minecraft:spawner{SpawnCount:8,SpawnRange:12,Delay:100,MinSpawnDelay:800,MaxSpawnDelay:1600,MaxNearbyEntities:2,RequiredPlayerRange:24,SpawnData:{id:"minecraft:cave_spider",Silent:1b}}
