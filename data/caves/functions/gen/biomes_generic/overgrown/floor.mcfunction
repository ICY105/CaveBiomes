...
execute if score $gen.out_1 cave_data matches 000..099 positioned ~ ~1 ~ if block ~ ~ ~ #caves:cave_decoration run setblock ~ ~ ~ minecraft:cobblestone_slab
execute if score $gen.out_1 cave_data matches 200..299 positioned ~ ~1 ~ if block ~ ~ ~ #caves:cave_decoration run setblock ~ ~ ~ minecraft:mossy_cobblestone_slab[waterlogged=false]
