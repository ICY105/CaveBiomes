...
execute if score $gen.out_0 cave_data matches 100..290 run setblock ~ ~ ~ minecraft:dirt
execute if score $gen.out_0 cave_data matches 300..490 run setblock ~ ~ ~ minecraft:coarse_dirt
execute if score $gen.out_0 cave_data matches 500..999 run setblock ~ ~ ~ minecraft:podzol

execute if score $gen.out_1 cave_data matches 000..099 positioned ~ ~1 ~ if block ~ ~ ~ #caves:cave_decoration run setblock ~ ~ ~ minecraft:granite_slab
