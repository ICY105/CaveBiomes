...
execute if score in_0 cave_data matches 81 if score out_1 cave_data matches 001..003 positioned ~ ~-1 ~ if block ~ ~ ~ #caves:stone run setblock ~ ~ ~ minecraft:spawner{SpawnCount:8,SpawnRange:12,Delay:100,MinSpawnDelay:800,MaxSpawnDelay:1600,MaxNearbyEntities:2,RequiredPlayerRange:24,SpawnData:{id:"minecraft:husk"}}
execute if score in_0 cave_data matches 81 if score out_1 cave_data matches 001..080 positioned ~ ~1 ~ if block ~ ~ ~ #caves:cave_decoration run setblock ~ ~ ~ minecraft:nether_wart[age=2]
