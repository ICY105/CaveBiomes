...
execute if score $gen.in_0 cave_data matches 40 if score $gen.out_1 cave_data matches 001..003 if score $config.enable.spawner cave_data matches 1 run setblock ~ ~ ~ minecraft:spawner{SpawnCount:8,SpawnRange:12,Delay:100,MinSpawnDelay:800,MaxSpawnDelay:1600,MaxNearbyEntities:2,RequiredPlayerRange:24,SpawnData:{id:"minecraft:guardian"}}

#coral
execute if score $gen.in_0 cave_data matches 41 run function caves:decor/random_coral
execute if score $gen.in_0 cave_data matches 41 if score $gen.out_1 cave_data matches 001..003 if score $config.enable.spawner cave_data matches 1 run setblock ~ ~ ~ minecraft:spawner{SpawnCount:8,SpawnRange:12,Delay:100,MinSpawnDelay:800,MaxSpawnDelay:1600,MaxNearbyEntities:2,RequiredPlayerRange:24,SpawnData:{id:"minecraft:tropical_fish"}}
