...
execute if score in_0 cave_data matches 40 if score out_1 cave_data matches 000..100 positioned ~ ~-1 ~ if block ~ ~ ~ #caves:cave_decoration-water run setblock ~ ~ ~ minecraft:prismarine_wall[waterlogged=true]
