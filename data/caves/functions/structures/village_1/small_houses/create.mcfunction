...
execute if score out_0 du_data matches 0 run data merge block ~ ~ ~ {name: "caves:village_1/small_houses/library_1"}
execute if score out_0 du_data matches 1 run data merge block ~ ~ ~ {name: "caves:village_1/small_houses/tool_smith_1"}
execute if score out_0 du_data matches 2 run data merge block ~ ~ ~ {name: "caves:village_1/small_houses/cartographer_1"}
execute if score out_0 du_data matches 3 run data merge block ~ ~ ~ {name: "caves:village_1/small_houses/mason_1"}
execute if score out_0 du_data matches 4 run data merge block ~ ~ ~ {name: "caves:village_1/small_houses/tannery_1"}
execute if score out_0 du_data matches 5 run data merge block ~ ~ ~ {name: "caves:village_1/small_houses/fletcher_1"}
execute if score out_0 du_data matches 6 run data merge block ~ ~ ~ {name: "caves:village_1/small_houses/butcher_1"}
execute if score out_0 du_data matches 7 run data merge block ~ ~ ~ {name: "caves:village_1/small_houses/armorer_1"}
execute if score out_0 du_data matches 8 run data merge block ~ ~ ~ {name: "caves:village_1/small_houses/weaponsmith_1"}
execute if score out_0 du_data matches 9 run data merge block ~ ~ ~ {name: "caves:village_1/small_houses/farm_1"}
