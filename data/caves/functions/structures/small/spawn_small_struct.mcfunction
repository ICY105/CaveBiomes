...
execute if score out_0 du_data matches 4..5 run setblock ~ ~ ~ minecraft:structure_block{posX: 0, posY: 0, posZ: 0, name: "caves:caves/ravine_1", mode: "LOAD", showboundingbox: 0b}

execute if score out_0 du_data matches 6..7 run setblock ~ ~ ~ minecraft:structure_block{posX: 0, posY: 0, posZ: 0, name: "caves:caves/slip_1", mode: "LOAD", showboundingbox: 0b}
