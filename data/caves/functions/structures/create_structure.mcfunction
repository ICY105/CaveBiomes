...
execute if score temp_0 cave_data matches 1 run function caves:structures/create_medium_struct
execute unless score in_0 cave_data matches 40..59 if score temp_0 cave_data matches 2 run function caves:structures/create_village
