...
execute if score temp_0 cave_data matches 33..39 run scoreboard players set in_0 cave_data 82
execute if score temp_0 cave_data matches 33..39 run scoreboard players set in_1 cave_data 32

execute if score temp_0 cave_data matches 40 run scoreboard players set in_0 cave_data 83
execute if score temp_0 cave_data matches 40 run scoreboard players set in_1 cave_data 33
