...
execute if score timer_100 du_data matches 0..19 if data entity @s Inventory[{Slot:101b,tag:{caves_element:3}}] run effect give @s minecraft:absorption 10 0 true
